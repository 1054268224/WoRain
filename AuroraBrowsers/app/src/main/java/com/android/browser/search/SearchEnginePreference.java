...
class SearchEnginePreference extends ListPreference {
    ...
    public SearchEnginePreference(Context context, AttributeSet attrs) throws Exception {
        super(context, attrs);
        ...
        for (com.wheatek.reflect.SearchEngine searchEngineInfo : SearchEngines
                                                    .getSearchEngineInfos(context)) {
