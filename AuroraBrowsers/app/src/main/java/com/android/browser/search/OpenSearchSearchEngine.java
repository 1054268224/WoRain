...
import com.wheatek.reflect.Streams;
...
public class OpenSearchSearchEngine implements SearchEngine {
    ...
    private final com.wheatek.reflect.SearchEngine mSearchEngine;
    ...
    public void startSearch(Context context, String query, Bundle appData, String extraData) throws Exception {
     ...
     */
    public Cursor getSuggestions(Context context, String query) throws Exception {
