...
import com.wheatek.reflect.CarrierExpressManager;
...
public class BrowserActivity extends Activity {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                CarrierExpressManager m = null;
                try {
                    if (action.equals(m.getConst("ACTION_OPERATOR_CONFIG_CHANGED"))) {
                        Extensions.resetPlugins();
                        Extensions.getRegionalPhonePlugin(context)
                                .updateBookmarks(context);
                    }
    ...
    private void handleSearchEngineChanged() throws Exception {
...
//        mIntentFilter.addAction(CarrierExpressManager.ACTION_OPERATOR_CONFIG_CHANGED);
        try {
            mIntentFilter.addAction(m.getConst("ACTION_OPERATOR_CONFIG_CHANGED"));
        } catch (Exception e) {
            e.printStackTrace();
        }
   ...
   /* @VisibleForTesting
    ...
    private PermissionHelper.PermissionCallback mPermissionCallback =
        ...
        public void onPermissionsResult(int requestCode, String[] permissions, int[] grantResults) throws Exception {
