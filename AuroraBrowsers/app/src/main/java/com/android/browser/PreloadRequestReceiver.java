...
public class PreloadRequestReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_PRELOAD = "com.android.browser.intent.action.PRELOAD";
    ...
    private void handlePreload(Context context, Intent i) throws Exception {
