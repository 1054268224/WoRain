...
public interface WebViewController {
    ...
    void createSubWindow(Tab tab) throws Exception;

    void onPageStarted(Tab tab, WebView view, Bitmap favicon) throws Exception;

    void onPageFinished(Tab tab) throws Exception;

    void onProgressChanged(Tab tab);

    void onReceivedTitle(Tab tab, final String title) throws Exception;

    void onFavicon(Tab tab, WebView view, Bitmap icon) throws Exception;

    boolean shouldOverrideUrlLoading(Tab tab, WebView view, String url) throws Exception;
    ...
    void onDownloadStart(Tab tab, String url, String useragent, String contentDisposition,
            String mimeType, String referer, long contentLength) throws Exception;
    ...
    void onUserCanceledSsl(Tab tab) throws Exception;

    boolean shouldShowErrorConsole();

    void onUpdatedSecurityState(Tab tab) throws Exception;
    ...
    /**
     * Send error code to STK.
     * @param error error code from webview
     * @param url access website
     */
    void sendErrorCode(int error, String url);
}
