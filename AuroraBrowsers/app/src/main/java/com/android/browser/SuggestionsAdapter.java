...
public class SuggestionsAdapter extends BaseAdapter implements Filterable,
    ...
    interface CompletionListener {
        ...
        public void onSelect(String txt, int type, String extraData) throws Exception;
    ...
    class SuggestFilter extends Filter {
        ...
        private boolean shouldProcessEmptyQuery() throws Exception {
    ...
    abstract class CursorSource {
        ...
        public abstract void runQuery(CharSequence constraint) throws Exception;
    ...
    class SuggestCursor extends CursorSource {
        ...
        @Override
        public void runQuery(CharSequence constraint) throws Exception {
            if (mCursor != null) {
                mCursor.close();
            }
