...
public class CircleBarTwoSider extends View {
    ...
    public CircleBarTwoSider(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        /*getAttributes(context,attrs);*/
    }

    private void getAttributes(Context context, AttributeSet attrs){
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CircleBarTwoSider);
        circleStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.CircleBarTwoSider_circle_stroke_width, (int) UnitUtil.dip2px(context,10f));
        pressExtraStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.CircleBarTwoSider_press_extra_stroke_width, (int) UnitUtil.dip2px(context,2f));
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.CircleBarTwoSider_text_size, (int) UnitUtil.dip2px(context,20f));
    }
    private void init(AttributeSet attrs, int defStyle){

        mColorWheelPaintRight = new Paint(Paint.ANTI_ALIAS_FLAG);
        mColorWheelPaintRight.setColor(0xFF29a6f6);
        mColorWheelPaintRight.setStyle(Style.STROKE);
...
//        mColorWheelPaintRight.setStrokeCap(Paint.Cap.ROUND);//开启显示边缘为圆形
        ...
        mColorWheelPaintLeft.setStyle(Style.STROKE);
