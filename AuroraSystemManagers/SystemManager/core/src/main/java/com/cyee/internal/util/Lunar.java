package com.cyee.internal.util;
...
public class Lunar {
    ...
    public static final String TAG = "Lunar"; 
    ...
    public static final int FLAG_SHOW_FESTIVAL = 0b1000;
    public static final int FLAG_SHOW_DAY_FIRSTDAY_BY_MONTH = 0b10000;
    public static final int FLAG_SHOW_ANIMAL = 0b100000;
    ...
    public static final String NAME_LEAP = "闰";
    ...
    public static final String[] MONTH_NUMBER_ARRAY = {"正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬",
            "腊"};
    private static final String[] TENS_PREFIX_ARRAY = {"初", "十", "廿", "卅"};

    private static final String[] DAY_NUMBER_ARRAY = {"初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九",
            "初十", "十一", "十二", "十三", "十四", "十五", "十六", "十七", "十八", "十九", "二十", "廿一", "廿二", "廿三", "廿四", "廿五",
            "廿六", "廿七", "廿八", "廿九", "三十"};

    private final static String[] Tianan = {"甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸"};
    private final static String[] Deqi = {"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥"};
    ...
    public static final byte[] SSolarArray = {
            // 1970
            6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 9, 24, 8, 23, 7, 22, 6, 21, 4, 19,
            6, 21, 5, 21, 6, 22, 6, 22, 8, 23, 8, 24, 8, 24, 9, 24, 8, 23, 8, 22, 6, 21, 5, 19, 5, 20, 5, 20,
            5, 21, 5, 21, 7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20, 5, 21, 6, 21,
            7, 23, 8, 23, 8, 23, 8, 23, 7, 22, 7, 22, 6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23,
            8, 23, 9, 24, 8, 23, 7, 22, 6, 21, 4, 19, 6, 21, 5, 21, 6, 22, 6, 22, 8, 23, 8, 24, 8, 23, 9, 24,
            8, 23, 8, 22, 6, 21, 4, 19, 5, 20, 4, 20, 5, 21, 5, 21, 7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22,
            5, 20, 4, 19, 6, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23, 8, 23, 8, 23, 7, 22, 7, 22, 6, 20,
            4,
            19,
            6,
            21,
            ...
            22,
            // 1980
            6, 21, 4, 19, 5, 20, 4, 20, 5, 21, 5, 21, 7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 21, 5, 20, 4, 19,
            6, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23, 8, 23, 8, 23, 7, 22, 7, 22, 6, 20, 4, 19, 6, 21, 5, 20,
            6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 8, 24, 8, 22, 7, 22, 6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22,
            8, 23, 8, 24, 8, 23, 9, 24, 8, 23, 8, 22, 6, 21, 4, 19, 5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23,
            7, 23, 8, 23, 7, 22, 7, 21, 5, 20, 4, 19, 5, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23, 8, 23, 8, 23,
            7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 8, 24, 8, 22, 7, 22,
            6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 24, 8, 23, 9, 24, 8, 23, 7, 22, 6, 21, 4, 19,
            5, 20, 4, 20, 5, 21, 5,
            21,
            7,
            22,
            ...
            22,
            // 1990
            5, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 21, 7, 23, 8, 23, 8, 23, 8, 24, 8, 22, 7, 22, 6, 20, 4, 19,
            6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 9, 24, 8, 23, 7, 22, 6, 21, 4, 19, 5, 20, 4, 20,
            5, 21, 5, 21, 7, 22, 7, 23, 7, 23, 8, 23, 7, 22, 7, 21, 5, 20, 4, 18, 5, 20, 5, 20, 5, 21, 6, 21,
            7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 21, 7, 23, 8, 23,
            8, 23, 8, 23, 7, 22, 7, 22, 6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 9, 24,
            8, 23, 7, 22, 6, 21, 4, 19, 5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23, 7, 23, 8, 23, 7, 22, 7, 21,
            5, 20, 4, 18, 5, 20, 5, 20, 5, 21, 5, 21, 7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19,
            6, 21, 5, 20, 6, 21, 6, 21, 7, 23, 8, 23, 8, 23, 8,
            23,
            7,
            22,
            7,
            ...
            22,
            // 2000
            6, 21, 4, 19, 5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23, 7, 23, 8, 23, 7, 22, 7, 21, 5, 20, 4, 18,
            5, 20, 5, 20, 5, 21, 5, 21, 7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20,
            6, 21, 6, 21, 7, 23, 8, 23, 8, 23, 8, 23, 7, 22, 7, 22, 6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22,
            7, 23, 8, 23, 8, 23, 9, 24, 8, 23, 7, 22, 6, 21, 4, 19, 5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23,
            7, 23, 8, 23, 7, 22, 7, 21, 5, 20, 4, 18, 5, 20, 5, 20, 5, 21, 5, 21, 7, 23, 7, 23, 7, 23, 8, 23,
            7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23, 8, 23, 8, 23, 7, 22, 7, 22,
            6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 9, 24, 8, 23, 7, 22, 6, 20, 4, 19,
            5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23, 7, 22, 8, 23, 7, 22, 7, 21, 5, 20, 4,
            18,
            5,
            20,
            4,
            ...
            22,
            // 2010
            5, 20, 4, 19, 6, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23, 8, 23, 8, 23, 7, 22, 7, 22, 6, 20, 4, 19,
            6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 8, 24, 8, 23, 7, 22, 6, 21, 4, 19, 5, 20, 4, 20,
            5, 20, 5, 21, 7, 22, 7, 23, 7, 22, 8, 23, 7, 22, 7, 21, 5, 20, 4, 18, 5, 20, 4, 20, 5, 21, 5, 21,
            7, 22, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23,
            8, 23, 8, 23, 7, 22, 7, 22, 6, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 22, 7, 23, 8, 23, 8, 23, 8, 24,
            8, 22, 7, 22, 6, 20, 4, 19, 5, 20, 4, 19, 5, 20, 5, 21, 7, 22, 7, 23, 7, 22, 8, 23, 7, 22, 7, 21,
            5, 20, 3, 18, 5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19,
            5, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23, 8, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20,
            6, 21, 6, 21,
            7,
            23,
            8,
            ...
            22,
            // 2020
            6, 20, 4, 19, 5, 20, 4, 19, 5, 20, 5, 21, 6, 22, 7, 22, 7, 22, 8, 23, 7, 22, 7, 21, 5, 20, 3, 18,
            5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23, 7, 23, 8, 23, 7, 22, 7, 21, 5, 20, 4, 19, 5, 20, 5, 20,
            5, 21, 6, 21, 7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 21,
            7, 23, 8, 23, 8, 23, 8, 24, 8, 22, 7, 22, 6, 20, 4, 19, 5, 20, 4, 19, 5, 20, 5, 21, 6, 22, 7, 22,
            7, 22, 8, 23, 7, 22, 6, 21, 5, 20, 3, 18, 5, 20, 4, 20, 5, 21, 5, 21, 7, 22, 7, 23, 7, 23, 8, 23,
            7, 22, 7, 21, 5, 20, 4, 18, 5, 20, 5, 20, 5, 21, 5, 21, 7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22,
            5, 20, 4, 19, 6, 21, 5, 20, 6, 21, 6, 21, 7, 23, 8, 23, 8, 23, 8, 23, 7, 22, 7, 22, 6, 20, 4, 19,
            5, 20, 4, 19, 5, 20, 5, 21, 6, 22, 7, 22, 7, 22, 8, 23, 7, 22, 6, 21, 5, 20, 3, 18, 5, 20, 4, 20,
            5, 21, 5, 21, 7, 22, 7, 23, 7, 23, 8, 23,
            7,
            22,
            7,
            21,
            // 2030
            5, 20, 4, 18, 5, 20, 5, 20, 5, 21, 5, 21, 7, 23, 7, 23, 7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19,
            6, 21, 5, 20, 6, 21, 6, 21, 7, 23, 8, 23, 8, 23, 8, 23, 7, 22, 7, 22, 6, 20, 4, 19, 5, 20, 4, 19,
            5, 20, 5, 21, 6, 22, 7, 22, 7, 22, 8, 23, 7, 22, 6, 21, 5, 20, 3, 18, 5, 20, 4, 20, 5, 21, 5, 21,
            7, 22, 7, 23, 7, 23, 8, 23, 7, 22, 7, 21, 5, 20, 4, 18, 5, 20, 5, 20, 5, 21, 5, 21, 7, 23, 7, 23,
            7, 23, 8, 23, 7, 22, 7, 22, 5, 20, 4, 19, 6, 21, 5, 20, 5, 21, 6, 21, 7, 23, 7, 23, 8, 23, 8, 23,
            7, 22, 7, 22, 6, 20, 4, 19, 5, 20, 4, 19, 5, 20, 5, 21, 6, 22, 7, 22, 7, 22, 8, 23, 7, 22, 6, 21};
    ...
    private static final Calendar sSolar;
    ...
    static {
        ...
        // Gionee <weidong> <2017-5-9> modify for 11388 begin
        sUtcCal = new GregorianCalendar(TimeZone.getDefault());
        // Gionee <weidong> <2017-5-9> modify for 11388 end
    }
    ...
    public static final int[] lunarToSolar(int year, int month, int monthDay, boolean isLeapMonth) {
        ...
        if (year < MIN_YEAR || year > MAX_YEAR || month < 1 || month > 12 || monthDay < 1 || monthDay > 30) {
          Log.e(TAG, "lunarToSolar year=" + year + " month=" + month + " day=" + monthDay + " isLeapMonth="
          + isLeapMonth);
    ...
    private static boolean islittleDecember(int year) {
        ...
        return (LUNAR_INFO[year - MIN_YEAR] & (0x80000 >> (month - 1))) == 0;
    }
    ...
    public static int monthInYear(int year) {
        int leapMonth = leapMonth(year);
     ...
     * @return 农历年生肖(例:龙)
     */
    public static String getLunarAnimalString(int lunarYear) {
     ...
     * 取农历年生肖
     * 
     * @param solarYear 公历日期
     * @return 农历年生肖(例:龙)
     */
    public static String getSolarAnimalString(int solarYear, int solarMonth, int solarDay) {
        int term2 = (LUNAR_INFO[solarYear - MIN_YEAR] & 0x001F) - 1;
        if (((LUNAR_INFO[solarYear - MIN_YEAR] & 0x0060) >> 5) == 2) {
            term2 += 31;
        }
        int lunarYear = 1900;
        if (solarMonth <= 1 && (solarMonth * 31 + solarDay <= term2)) {
    ...
    /**
     * 以正月初一为界 返回指定数字的公历年份表示字符串
     * 
     * @param solarYear
     *            公历年份(数字,0为甲子)
     * @return 公历年份字符串
     */
    public static String getLunarYearString(int solarYear, int solarMonth, int solarDay) {
        // 干支年 1900年春节後为庚子年(60进制36)
        int term2 = (LUNAR_INFO[solarYear - MIN_YEAR] & 0x001F) - 1;
        if (((LUNAR_INFO[solarYear - MIN_YEAR] & 0x0060) >> 5) == 2) {
            term2 += 31;
        }
        int cyclicalYear = 1900;
        if (solarMonth <= 1 && (solarMonth * 31 + solarDay <= term2)) {
     ...
     * @return 公历月份字符串
     */
    public static String getLunarMonthString(int solarYear, int solarMonth, int solarDay) {
        // 干支月 1900年1月小寒以前为 丙子月(60进制12)
        int firstNode = getAMonthSolarTermDays(solarYear, solarMonth + 1)[0]; // 传回当月「节」为几日开始
        // 依节气月柱, 以「节」为界
        int cyclicalMonth = 1900;
     ...
     * @return 公历日字符串
     */
    public static String getLunarDayString(int solarYear, int solarMonth, int solarDay) {
        return getCyclicalString((int) (UTC(solarYear, solarMonth, solarDay, 0, 0, 0) / 86400000 + 25567 + 10) % 60);
    }

    /**
     * The really function produce lunar year info.
     */
    public static String getLunarInfoString(int solarYear, int solarMonth, int solarDay, int showFlag) {
        boolean isShowDay = (showFlag & FLAG_SHOW_DAY) != 0;
        boolean isShowMonth = (showFlag & FLAG_SHOW_MONTH) != 0;
        boolean isShowYear = (showFlag & FLAG_SHOW_YEAR) != 0;
        boolean isShowAnimal = (showFlag & FLAG_SHOW_ANIMAL) != 0;
        try {
            String year = isShowYear ? getLunarYearString(solarYear, solarMonth, solarDay) : "";
            String month = isShowMonth ? getLunarMonthString(solarYear, solarMonth, solarDay) + NAME_MONTH
                    : "";
            String day = isShowDay ? getLunarDayString(solarYear, solarMonth, solarDay) : "";
            String animal = isShowAnimal ? getSolarAnimalString(solarYear, solarMonth, solarDay) : "";
            return year + animal + NAME_YEAR + month + day;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    private static String getCyclicalString(int cyclicalNumber) {
        return Tianan[cyclicalNumber % 10] + Deqi[cyclicalNumber % 12];
    }
     ...
     * 
     * @param year
     * @return 获取农历年中所有的农历月份名字，包括闰月，例如2014年有13个月：正月，二月。。。九月，闰九月。。。腊月
     */
    public static List<String> getMonthsNameInYear(int year) {
        int leap = leapMonth(year);
        List<String> monthsNameList = getNormalMonthsName();
        if (leap > 0) {
            String leapMonthName = NAME_LEAP + MONTH_NUMBER_ARRAY[leap - 1] + NAME_MONTH;
            monthsNameList.add(leap, leapMonthName);
        }
    ...
    /**
     * 
     * @return 常规的12个月的农历名称,不包含闰月：正月，二月，三月。。。。冬月，腊月。
     */
    public static List<String> getNormalMonthsName() {
        List<String> monthList = new ArrayList<String>();

        for (String num : MONTH_NUMBER_ARRAY) {
            monthList.add(num + NAME_MONTH);
        }

        return monthList;
    }

    public static List<String> getNormalMonthsName(int start, int end) {
        List<String> monthList = new ArrayList<String>();
        for (int i = 0; i < MONTH_NUMBER_ARRAY.length; i++) {
            if (start <= i && i <= end) {
                monthList.add(MONTH_NUMBER_ARRAY[i] + NAME_MONTH);
            }
        }
        return monthList;
    }
    
    public static String[] getDaysDisplayName(int days) {
        String[] displayNameArray = new String[days];

        for (int i = 0; i < days; i++) {
            displayNameArray[i] = DAY_NUMBER_ARRAY[i];
        }

        return displayNameArray;
    }

    public static String[] getDaysDisplayName(int start, int end) {
        String[] displayNameArray = new String[end - start + 1];
        for (int i = start; i <= end; i++) {
            displayNameArray[i - start] = DAY_NUMBER_ARRAY[i];
        }
        return displayNameArray;
    }

    public static String getLunarYearDislayValue(long timeMillis) {
        Calendar c = Calendar.getInstance();
        c.setTimeInMillis(timeMillis);
        int solarYear = c.get(Calendar.YEAR);
        int solarMonth = c.get(Calendar.MONTH);
        int solarDay = c.get(Calendar.DAY_OF_MONTH);

        String lunarYearString = getLunarYearString(solarYear, solarMonth, solarDay);

        return lunarYearString + NAME_YEAR; // 甲午年
    }

    public static String getLunarMonthDislayValue(long timeMillis) {
        int[] lunar = solarToLunar(timeMillis);
        int lunarMonth = lunar[1];
        boolean isLeapMonth = lunar[3] == 1;

        String lunarMonthString = MONTH_NUMBER_ARRAY[lunarMonth - 1] + NAME_MONTH;

        if (isLeapMonth) {

            return NAME_LEAP + lunarMonthString;// 闰九月

        } else {

            return lunarMonthString;// 九月
        }

    }

    public static String getLunarDayDislayValue(long timeMillis) {
        int[] lunar = solarToLunar(timeMillis);
        int lunarDay = lunar[2];

        String lunarDayString = DAY_NUMBER_ARRAY[lunarDay - 1];
