 ...
 *
 */
public class CyeeSmartPopupLayout extends CyeeSmartLayout {
	
	public static String USER_DEGREE = "user_popup_degree";
	private final long TIME_INTERNAL = (long) (2.5 * 1000);

	public CyeeSmartPopupLayout(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public CyeeSmartPopupLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}
