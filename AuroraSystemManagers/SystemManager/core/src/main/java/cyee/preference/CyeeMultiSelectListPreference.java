 ...
 */
public class CyeeMultiSelectListPreference extends CyeeDialogPreference {
    ...
    public CyeeMultiSelectListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        // Gionee <zhangxx> <2013-08-14> add for CR00857086 end
            TypedArray a = context.obtainStyledAttributes(attrs,
                    R.styleable.CyeeMultiSelectListPreference, 0, 0);
            mEntries = a.getTextArray(R.styleable.CyeeMultiSelectListPreference_cyeeentries);
            mEntryValues = a.getTextArray(R.styleable.CyeeMultiSelectListPreference_cyeeentryValues);
            a.recycle();
        // Gionee <zhangxx> <2013-08-14> add for CR00857086 begin
        }
        // Gionee <zhangxx> <2013-08-14> add for CR00857086 end
    ...
    public CyeeMultiSelectListPreference(Context context) {
        this(context, null);
    }
