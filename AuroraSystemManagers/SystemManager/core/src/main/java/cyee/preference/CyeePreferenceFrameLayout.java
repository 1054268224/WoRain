 ...
 * @hide
 */
public class CyeePreferenceFrameLayout extends FrameLayout {
    ...
    public CyeePreferenceFrameLayout(Context context) {
        this(context, null);
    }

    public CyeePreferenceFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);//com.android.internal.R.attr.preferenceFrameLayoutStyle);
    }

    public CyeePreferenceFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void addView(View child) {
        ...
        LayoutParams layoutParams = params instanceof CyeePreferenceFrameLayout.LayoutParams
            ? (CyeePreferenceFrameLayout.LayoutParams) child.getLayoutParams() : null;
