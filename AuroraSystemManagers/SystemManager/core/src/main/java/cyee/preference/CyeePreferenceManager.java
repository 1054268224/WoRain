 ...
 */
public class CyeePreferenceManager {
     ...
     */
    public static final String METADATA_KEY_PREFERENCES = "cyee.preference";
     ...
     */
    private CyeePreferenceFragment mFragment;
     ...
     */
    private CyeePreferenceScreen mPreferenceScreen;
    ...
    CyeePreferenceManager(Activity activity, int firstRequestCode) {
        mActivity = activity;
     ...
     */
    private CyeePreferenceManager(Context context) {
        init(context);
    }
     ...
     */
    void setFragment(CyeePreferenceFragment fragment) {
        mFragment = fragment;
    }
     ...
     */
    CyeePreferenceFragment getFragment() {
        return mFragment;
    }
     ...
     *         root).
     */
    CyeePreferenceScreen inflateFromIntent(Intent queryIntent, CyeePreferenceScreen rootPreferences) {
        ...
        for (int i = activities.size() - 1; i >= 0; i--) {
            ...
            if (!inflatedRes.contains(uniqueResId)) {
                ...
                final CyeePreferenceInflater inflater = new CyeePreferenceInflater(context, this);
                final XmlResourceParser parser = activityInfo.loadXmlMetaData(context
                        .getPackageManager(), METADATA_KEY_PREFERENCES);
                /*weidong comment*/
                /*rootPreferences = (CyeePreferenceScreen) inflater
     ...
     * @hide
     */
    public CyeePreferenceScreen inflateFromResource(Context context, int resId,
            CyeePreferenceScreen rootPreferences) {
        // Block commits
        setNoCommit(true);

        final CyeePreferenceInflater inflater = new CyeePreferenceInflater(context, this);
        rootPreferences = (CyeePreferenceScreen) inflater.inflate(resId, rootPreferences, true);
        rootPreferences.onAttachedToHierarchy(this);
    ...
    public CyeePreferenceScreen createPreferenceScreen(Context context) {
        final CyeePreferenceScreen preferenceScreen = new CyeePreferenceScreen(context, null);
     ...
     */
    CyeePreferenceScreen getPreferenceScreen() {
     ...
     */
    boolean setPreferences(CyeePreferenceScreen preferenceScreen) {
    ...
    public static void setDefaultValues(Context context, String sharedPreferencesName,
        ...
        if (readAgain || !defaultValueSp.getBoolean(KEY_HAS_SET_DEFAULT_VALUES, false)) {
            final CyeePreferenceManager pm = new CyeePreferenceManager(context);
    ...
    public interface OnPreferenceTreeClickListener {
         ...
         */
        boolean onPreferenceTreeClick(CyeePreferenceScreen preferenceScreen, CyeePreference preference);
    }
