 ...
 */
public class CyeeMultiCheckPreference extends CyeeDialogPreference {
    ...
    public CyeeMultiCheckPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        // Gionee <zhangxx> <2013-08-14> add for CR00857086 end
            ...
            setEntryValuesCS(a.getTextArray(
                    R.styleable.CyeeListPreference_cyeeentryValues));
            a.recycle();
    ...
    public CyeeMultiCheckPreference(Context context) {
        this(context, null);
    }
