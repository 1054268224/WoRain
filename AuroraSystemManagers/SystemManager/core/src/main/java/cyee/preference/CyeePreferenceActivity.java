 ...
 */
public abstract class CyeePreferenceActivity extends CyeeListActivity implements
        CyeePreferenceManager.OnPreferenceTreeClickListener,
        CyeePreferenceFragment.OnPreferenceStartFragmentCallback {
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                view = mInflater.inflate(com.cyee.internal.R.layout.cyee_preference_header_item,
                        parent, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cyee.internal.R.layout.cyee_preference_list_content);

        mListFooter = (FrameLayout)findViewById(com.cyee.internal.R.id.cyee_list_footer);
        mPrefsContainer = (ViewGroup) findViewById(com.cyee.internal.R.id.cyee_prefs_frame);
        ...
        if (initialFragment != null && mSinglePane) {
            ...
            findViewById(com.cyee.internal.R.id.cyee_headers).setVisibility(View.GONE);
            ...
            // of preferences" mode.
            setContentView(com.cyee.internal.R.layout.cyee_preference_list_content_single);
            mListFooter = (FrameLayout) findViewById(com.cyee.internal.R.id.cyee_list_footer);
            mPrefsContainer = (ViewGroup) findViewById(com.cyee.internal.R.id.cyee_prefs);
            mPreferenceManager = new CyeePreferenceManager(this, FIRST_REQUEST_CODE);
        ...
        if (intent.getBooleanExtra(EXTRA_PREFS_SHOW_BUTTON_BAR, false)) {
            ...
            findViewById(com.cyee.internal.R.id.cyee_button_bar).setVisibility(View.VISIBLE);

            Button backButton = (Button)findViewById(com.cyee.internal.R.id.cyee_back_button);
            ...
            Button skipButton = (Button)findViewById(com.cyee.internal.R.id.cyee_skip_button);
            ...
            mNextButton = (Button)findViewById(com.cyee.internal.R.id.cyee_next_button);
    ...
    public boolean onIsMultiPane() {
        boolean preferMultiPane = getResources().getBoolean(
                com.cyee.internal.R.bool.cyee_preferences_prefer_dual_pane);
            ...
            while ((type=parser.next()) != XmlPullParser.END_DOCUMENT
                ...
                if ("header".equals(nodeName)) {
                    ...
                    TypedArray sa = getResources().obtainAttributes(attrs,
                            R.styleable.CyeePreferenceHeader);
                    header.id = sa.getResourceId(
                            R.styleable.CyeePreferenceHeader_cyeeid,
                            (int)HEADER_ID_UNDEFINED);
                    TypedValue tv = sa.peekValue(
                            R.styleable.CyeePreferenceHeader_cyeetitle);
                    ...
                    tv = sa.peekValue(
                            R.styleable.CyeePreferenceHeader_cyeesummary);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(
                            R.styleable.CyeePreferenceHeader_cyeebreadCrumbTitle);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    tv = sa.peekValue(
                            R.styleable.CyeePreferenceHeader_cyeebreadCrumbShortTitle);
                    if (tv != null && tv.type == TypedValue.TYPE_STRING) {
                        if (tv.resourceId != 0) {
                    ...
                    header.iconRes = sa.getResourceId(
                            R.styleable.CyeePreferenceHeader_cyeeicon, 0);
                    header.fragment = sa.getString(
                            R.styleable.CyeePreferenceHeader_cyeefragment);
                    sa.recycle();
    ...
    @Override
    protected void onListItemClick(CyeeListView l, View v, int position, long id) {
    ...
    public void showBreadCrumbs(CharSequence title, CharSequence shortTitle) {
        if (mFragmentBreadCrumbs == null) {
            ...
            if (mSinglePane) {
                ...
                // View bcSection = findViewById(com.cyee.internal.R.id(this, "breadcrumb_section"));
    ...
    @Override
    public boolean onPreferenceStartFragment(CyeePreferenceFragment caller, CyeePreference pref) {
