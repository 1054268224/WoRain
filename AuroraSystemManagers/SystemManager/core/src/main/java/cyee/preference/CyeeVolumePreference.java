 ...
 * @hide
 */
public class CyeeVolumePreference extends CyeeSeekBarDialogPreference implements
CyeePreferenceManager.OnActivityStopListener, View.OnKeyListener {
    ...
    public CyeeVolumePreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        // Gionee <zhangxx> <2013-08-14> modify for CR00857086 end
            TypedArray a = context.obtainStyledAttributes(attrs,
                    R.styleable.CyeeVolumePreference, 0, 0);
            mStreamType = a.getInt(R.styleable.CyeeVolumePreference_cyeestreamType, 0);
            a.recycle();
        // Gionee <zhangxx> <2013-08-14> modify for CR00857086 begin
        }
        setShowArrow(true);
    ...
    protected void onBindDialogView(View view) {
        ...
        final SeekBar seekBar = (SeekBar) view.findViewById(com.cyee.internal.R.id.cyee_seekbar);
       ...
       if (mSeekBarVolumizer != null) {
           ...
           if (dialog != null && dialog.isShowing()) {
               View view = dialog.getWindow().getDecorView()
                       .findViewById(com.cyee.internal.R.id.cyee_seekbar);
        ...
        private void initSeekBar(SeekBar seekBar, Uri defaultUri) {
            ...
            if (defaultUri == null) {
                if (mStreamType == AudioManager.STREAM_RING) {
                    ...
                    defaultUri = RingtoneManager.getActualDefaultRingtoneUri(mContext, RingtoneManager.TYPE_ALARM);
                }
            }
