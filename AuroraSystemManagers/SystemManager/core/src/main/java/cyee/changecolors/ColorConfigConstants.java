...
public class ColorConfigConstants {
    ...
    public static final int THEME_TYPE_LIGHT = 1;// 明主题
    public static final int THEME_TYPE_DARK = 2;// 暗主题
    
    public static final int POWER_SAVING_ID = 2;//省电模式的id
    ...
    public static final int DEFAULT_APPBAR_COLOR_A1 = 0xff3d3d3d;
    
    public static final int DEFAULT_BACKGROUND_COLOR_B1 = 0xfffdfdfd; 
    public static final int DEFAULT_POPUP_BACKGROUND_COLOR_B2 = 0xfffefefe;
    public static final int DEFAULT_EDIT_TEXT_BACKGROUND_COLOR_B3 = 0x10000000;
    public static final int DEFAULT_BUTTON_BACKGROUND_COLOR_B4 = 0xffffffff;
    public static final int DEFAULT_STATUSBAR_BACKGROUND_COLOR_S1 = 0xff3a3a3a;
    public static final int DEFAULT_SYSTEM_NAVIGATION_BACKGROUND_COLOR_S2 = 0xff3a3a3a;
    public static final int DEFAULT_ACCENT_COLOR_G1 = 0xfffac300;
    public static final int DEFAULT_ACCENT_COLOR_G2 = 0x50fac300;
    public static final int DEFAULT_CONTENT_COLOR_PRIMARY_ON_APPBAR_T1 = 0xffffffff;
    public static final int DEFAULT_CONTENT_COLOR_SECONDARY_ON_APPBAR_T2 = 0xccffffff;
    public static final int DEFAULT_CONTENT_COLOR_THIRDLY_ON_APPBAR_T3 = 0x50ffffff;
    public static final int DEFAULT_CONTENT_COLOR_FORTHLY_ON_APPBAR_T4 = 0x20ffffff;
    
    public static final int DEFAULT_CONTENT_COLOR_PRIMARY_ON_BACKGROUD_C1 = 0xcc000000;
    public static final int DEFAULT_CONTENT_COLOR_SECONDARY_ON_BACKGROUD_C2 = 0x66000000;
    public static final int DEFAULT_CONTENT_COLOR_THIRDLY_ON_BACKGROUD_C3 = 0x33000000;
    
    public static final int DEFAULT_CONTENT_COLOR_ON_STATUSBAR_S3 = 0xffffffff;
    public static final int DEFAULT_THEME_TYPE = THEME_TYPE_LIGHT;
