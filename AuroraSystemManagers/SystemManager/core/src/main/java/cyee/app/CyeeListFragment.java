 ...
 */
public class CyeeListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.cyee.internal.R.layout.cyee_list_content,
                container, false);
    }
    ...
    private void ensureList() {
        ...
        if (root instanceof ListView) {
            mList = (CyeeListView)root;
        } else {
            mStandardEmptyView = (TextView)root.findViewById(com.cyee.internal.R.id.cyee_internalEmpty);
            if (mStandardEmptyView == null) {
