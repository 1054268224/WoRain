//Gionee <liuyb> <2014-3-31> modify for CR01126382 begin
...
public class SharedPreferencesProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.cydroid.systemmanager.sp";
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        try {
            mSp = getContext().getSharedPreferences("com.cydroid.softmanager_preferences", Context.MODE_MULTI_PROCESS);
            mEditor = mSp.edit();
            int match = URL_MATCHER.match(url);
    ...
    public Cursor query(Uri url, String[] projection, String selection, String[] defauleValues,
        ...
        try {
            ...
            if ("boolean".equals(str)) {
                cursor.addRow(new Object[] {mSp.getBoolean(selection, "true".equals(defauleValues[0]))});
            }
            if ("int".equals(str)) {
...
// Gionee <liuyb> <2014-3-31> modify for CR01126382 end