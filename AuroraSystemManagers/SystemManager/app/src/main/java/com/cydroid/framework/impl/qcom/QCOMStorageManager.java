...
public class QCOMStorageManager implements IGnStorageManager {
...
//        }
    ...
    /*
     * This method is for auto-switch storage path.
     * 
     * The Unit of requireSite is BYTE, 1K=1024B
     * 
     * U should keep last returned value, then check if current value equals
     * last value. If it's different , user need to be notify that storage state
     * is changed
     */
