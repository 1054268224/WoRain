    ...
    public class CyeeSettings {
        private static final String TAG = "CyeeSettings";

        public static final String CYEE_PROP_SETTING_VERSION = "sys.settings_cyee_version";
        public static final String AUTHORITY = "cyeesettings";
        public static final String TABLE_CONFIG = "config";
        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + TABLE_CONFIG);

        private static final Object sLock = new Object();

        private static IContentProvider mCyeeContentProvider = null;
        ...
        public static final String CYEE_SILENT_SWITCH = "cyee_silent_switch";
        public static final String CYEE_VIBRATION_SWITCH = "cyee_vibration_switch";
    ...
    //        synchronized (sLock) {
    //            cp = mCyeeContentProvider;
    //            if (cp == null) {
    //                cp = mCyeeContentProvider = cr.acquireProvider(CONTENT_URI.getAuthority());
    //            }
    //        }
    //        return cp;
    //    }
        ...
        private static IContentProvider lazyGetProvider(ContentResolver cr) {
            if (mCyeeContentProvider == null) {
                synchronized (sLock) {
                    if (mCyeeContentProvider == null)
                        mCyeeContentProvider = cr.acquireProvider(CONTENT_URI.getAuthority());
                }
            }
            return mCyeeContentProvider;
        }

        public static int getInt(ContentResolver cr, String name, int defaultValue) {
            String value = getStringValueFromTable(cr, CyeeSettings.TABLE_CONFIG, name, null);
            return (value != null) ? Integer.parseInt(value) : defaultValue;
        }

        public static String getString(ContentResolver cr, String name, String defaultValue) {
            return getStringValueFromTable(cr, CyeeSettings.TABLE_CONFIG, name, defaultValue);
        }

        //Gionee <wangguojing> <2013-11-01> add for CR00943056 begin
        public static String getString(ContentResolver cr, String name) {
            return getStringValueFromTable(cr, CyeeSettings.TABLE_CONFIG, name, null);
        }
        ...
        private static String getStringValueFromTable(ContentResolver cr, String table, String name, String defaultValue) {
            try {
                Log.d(TAG, "CyeeSettings get string name = " + name + " , defaultValue = " + defaultValue);
                ...
                if (b != null) {
                    String value = b.getString(CyeeSettings.VALUE);
                    Log.d(TAG, "CyeeSettings get string name = " + name + " , value = " + value);
                    return value;
                }
            } catch (Exception e) {
        ...
        public static boolean putString(ContentResolver cr, String name, String value) {
            ...
            try {
                ...
                arg.putString(CyeeSettings.VALUE, value);
                IContentProvider cp = lazyGetProvider(cr);
                //Gionee <liuyb> <2013-12-03> modify for CR00966303 begin
                Bundle result = null;
                try {
                ...
                re = result.getBoolean(CyeeSettings.VALUE, true);
            } catch (Exception e) {
        ...
        public static Bundle invokeCallMethod(ContentResolver cr, IContentProvider cp, String methodtype, String name, Bundle extras) {
            ...
            try {
                ...
                method = cpClass
                        .getDeclaredMethod("call", String.class, String.class, String.class, Bundle.class);
