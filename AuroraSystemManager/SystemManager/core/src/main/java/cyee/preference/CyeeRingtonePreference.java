 ...
 */
public class CyeeRingtonePreference extends CyeePreference implements
CyeePreferenceManager.OnActivityResultListener {
    ...
    public CyeeRingtonePreference(Context context, AttributeSet attrs, int defStyle, int defStyleRes) {
        ...
        if (NativePreferenceManager.getAnalyzeNativePreferenceXml() && attrs != null) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CyeeRingtonePreference,
                    defStyle, 0);
            mRingtoneType = a.getInt(R.styleable.CyeeRingtonePreference_cyeeringtoneType,
                    RingtoneManager.TYPE_RINGTONE);
            mShowDefault = a.getBoolean(R.styleable.CyeeRingtonePreference_cyeeshowDefault, true);
            mShowSilent = a.getBoolean(R.styleable.CyeeRingtonePreference_cyeeshowSilent, true);
            a.recycle();
            // Gionee <zhangxx> <2013-08-14> modify for CR00857086 begin
        }
        setShowArrow(true);
    ...
    public CyeeRingtonePreference(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, 0);
    }

    public CyeeRingtonePreference(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.ringtonePreferenceStyle);
    }
    
    public CyeeRingtonePreference(Context context) {
        this(context, null);
    }
    ...
    protected void onClick() {
        ...
        CyeePreferenceFragment owningFragment = getPreferenceManager().getFragment();
