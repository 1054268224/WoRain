 ...
 */
public abstract class CyeeDialogPreference extends CyeePreference implements
        DialogInterface.OnClickListener, DialogInterface.OnDismissListener,
        CyeePreferenceManager.OnActivityDestroyListener {
    private CyeeAlertDialog.Builder mBuilder;
    ...
    public CyeeDialogPreference(Context context, AttributeSet attrs, int defStyle, int defStyleRes) {
        ...
        // Gionee <zhangxx> <2013-08-14> add for CR00857086 end
            TypedArray a = context.obtainStyledAttributes(attrs,
                    R.styleable.CyeeDialogPreference, defStyle, 0);
            mDialogTitle = a.getString(R.styleable.CyeeDialogPreference_cyeedialogTitle);
            if (mDialogTitle == null) {
                // Fallback on the regular title of the preference
                // (the one that is seen in the list)
                mDialogTitle = getTitle();
            }
            mDialogMessage = a.getString(R.styleable.CyeeDialogPreference_cyeedialogMessage);
            mDialogIcon = a.getDrawable(R.styleable.CyeeDialogPreference_cyeedialogIcon);
            mPositiveButtonText = a.getString(R.styleable.CyeeDialogPreference_cyeepositiveButtonText);
            mNegativeButtonText = a.getString(R.styleable.CyeeDialogPreference_cyeenegativeButtonText);
            mDialogLayoutResId = a.getResourceId(R.styleable.CyeeDialogPreference_cyeedialogLayout,
                    mDialogLayoutResId);
            a.recycle();
        // Gionee <zhangxx> <2013-08-14> add for CR00857086 begin
        }
    ...
    public CyeeDialogPreference(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, 0);
    }

    public CyeeDialogPreference(Context context, AttributeSet attrs) {
     ...
     * <p>
     * Do not {@link CyeeAlertDialog.Builder#create()} or
     * {@link CyeeAlertDialog.Builder#show()}.
     */
    protected void onPrepareDialogBuilder(CyeeAlertDialog.Builder builder) {
    }
    ...
    protected void showDialog(Bundle state) {
        ...
        // Gionee zhangxx 2012-12-10 add for CR00715173 begin
        if (mFullScreenStyle) {
            mBuilder = new CyeeAlertDialog.Builder(context)
