...
class CyeeTextViewEditToolbar extends CyeeTextViewToolbar {
    ...
    private final int ID_SELECT_ALL_STR = com.cyee.internal.R.string.cyee_selectAll;
    private final int ID_START_SELECTING_TEXT_STR = com.cyee.internal.R.string.cyee_select;
    private final int ID_CUT_STR = com.cyee.internal.R.string.cyee_cut;
    private final int ID_COPY_STR = com.cyee.internal.R.string.cyee_copy;
    private final int ID_SWITCH_INPUT_METHOD_STR = com.cyee.internal.R.string.cyee_inputMethod;
  ...
  //gionee 20121210 guoyx modified for CR00734816 end
    ...
    CyeeTextViewEditToolbar(CyeeEditText hostView) {
        super(hostView);
        initToolbarItem();
    }
    ...
    private boolean onItemAction(int id) {
      ...
      //gionee 20121210 guoyx modified for CR00734816 end
        ...
        case ID_CUT:
            ...
            // if (mEditText instanceof GnExtractEditText) {
            // Gionee <zhangxx> <2103-11-12> add for CR00951066 begin
            int maxlength = mEditText.getText().length();
            if (end > maxlength) {
                end = maxlength;
            }
            // Gionee <zhangxx> <2103-11-12> add for CR00951066 end
        ...
        case ID_SWITCH_INPUT_METHOD:
            if (!(mEditText instanceof CyeeExtractEditText)) {
