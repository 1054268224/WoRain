 ...
 */
public class CyeeExtractEditText extends CyeeEditText {
    private InputMethodService mIME;
    private int mSettingExtractedText;

    public CyeeExtractEditText(Context context) {
        super(context, null);
    }

    public CyeeExtractEditText(Context context, AttributeSet attrs) {
        super(context, attrs, android.R.attr.editTextStyle);
    }

    public CyeeExtractEditText(Context context, AttributeSet attrs, int defStyle) {
