 ...
 *
 */
public abstract class CyeeSmartLayout extends LinearLayout {
	...
	public CyeeSmartLayout(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		init(context);
	}

	public CyeeSmartLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		init(context);
	}
