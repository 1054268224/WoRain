 ...
 */
public class CyeeBaseSwitch extends CompoundButton {
    private final static String LOGTAG = "CyeeBaseSwitch";
     ...
     */
    public CyeeBaseSwitch(Context context) {
        this(context, null);
    }
     ...
     */
    public CyeeBaseSwitch(Context context, AttributeSet attrs) {
     ...
     */
    public CyeeBaseSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public CyeeBaseSwitch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mShowText = a.getBoolean(com.android.internal.R.styleable.Switch_showText, false);
        ...
        try {
            thumbTintList = a.getColorStateList(com.android.internal.R.styleable.Switch_thumbTint);
        } catch (Exception e) {
            Log.e(LOGTAG, "thumbTint is null");
        }
        ...
        ColorStateList trackTintList = null;
        try {
            trackTintList = a.getColorStateList(com.android.internal.R.styleable.Switch_trackTint);
        } catch (Exception e) {
            Log.e(LOGTAG, "trackTint is null");
        }
        ...
        PorterDuff.Mode trackTintMode = null;
        try {
            trackTintMode = Drawable.parseTintMode(a.getInt(com.android.internal.R.styleable.Switch_trackTintMode, -1), null);
        } catch (Exception e) {
            Log.e(LOGTAG, "trackTintMode is null");
        }
        ...
        try {
            ...
            Log.e(LOGTAG, "switchTextAppearance is null");
        }
        if (appearance != 0) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mTrackDrawable != null) {
            trackW = mTrackDrawable.getIntrinsicWidth();
            trackH = mTrackDrawable.getIntrinsicHeight();
        }
        
        final int switchWidth = Math.max(mSwitchMinWidth,
                trackW + paddingLeft + paddingRight);
...
//            }
    ...
    private int getThumbOffset() {
        ...
        return (int) (thumbPosition * getThumbScrollRange() + 0.5f) 
                + (int) getResources().getDimension(com.cyee.internal.R.dimen.cyee_switch_thumb_margin);
    }
    ...
    private int getThumbScrollRange() {
        if (mTrackDrawable != null) {
            ...
            // Gionee <weidong> <2017-07-31> add for 171447 begin
            if (insets.left <= 0) {
                left = 0;
            }
            if (insets.right <= 0) {
            ...
            // Gionee <weidong> <2017-07-31> add for 171447 end
            return mSwitchWidth - mThumbWidth - padding.left - padding.right - left - right
                    - (int) getResources().getDimension(com.cyee.internal.R.dimen.cyee_switch_thumb_margin) * 2;
        } else {
            return 0;
        }
    }
...
//todo....
    ...
    public CharSequence getAccessibilityClassName() {
        return CyeeBaseSwitch.class.getName();
    }
    ...
    private static final FloatProperty<CyeeBaseSwitch> THUMB_POS = new FloatProperty<CyeeBaseSwitch>("thumbPos") {
        @Override
        public Float get(CyeeBaseSwitch object) {
            return object.mThumbPosition;
        }

        @Override
        public void setValue(CyeeBaseSwitch object, float value) {
