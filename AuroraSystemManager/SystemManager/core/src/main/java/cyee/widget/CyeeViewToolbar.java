 ...
 *
 */
public abstract class CyeeViewToolbar {
    //Gionee CR00311071 jipengfei 20110730 start
    private static final int TOLERANCE_TOUCH = 3;
    private static int TOOLBAR_ITEM_PADDING_LEFT_AND_RIGHT;
...
//gionee 20121210 guoyx modified for CR00734816 begin
    private final int mLeftDrawableResId;
    private final int mCenterDrawableResId;
    private final int mRightDrawableResId;
//gionee 20121210 guoyx modified for CR00734816 end	
    ...
    // Gionee <lihq> <2013-12-20> modify for CR00873172 begin
    private final int TOOLBAR_TOP_OFFSET = 5;
    // Gionee <lihq> <2013-12-20> modify for CR00873172 end
    ...
    public CyeeViewToolbar(View hostView) {
        ...
        TOOLBAR_ITEM_PADDING_LEFT_AND_RIGHT = resources
                .getInteger(com.cyee.internal.R.integer.cyee_toolbar_item_padding_left_and_right);
		//gionee 20121210 guoyx modified for CR00734816 begin
        mLeftDrawableResId = com.cyee.internal.R.drawable.cyee_text_toolbar_left;
        mCenterDrawableResId = com.cyee.internal.R.drawable.cyee_text_toolbar_center;
        mRightDrawableResId = com.cyee.internal.R.drawable.cyee_text_toolbar_right;
		//gionee 20121210 guoyx modified for CR00734816 end
        mSingleDrawable = resources.getDrawable(com.cyee.internal.R.drawable.cyee_text_toolbar_single);
        mArrowAboveDrawable = resources.getDrawable(com.cyee.internal.R.drawable.cyee_text_toolbar_position_arrow_above);
        mArrowBelowDrawable = resources.getDrawable(com.cyee.internal.R.drawable.cyee_text_toolbar_position_arrow_below);
        ...
        mToolbarView = mLayoutInflater.inflate(com.cyee.internal.R.layout.cyee_text_toolbar, null);
        mToolbarGroup = (ViewGroup) mToolbarView.findViewById(com.cyee.internal.R.id.cyee_toolbar_group);
        //Gionee CR00311071 jipengfei 20110730: comment out this line, it has nonsense
        //mToolbarGroup.setPadding(2, 2, 2, 2);
        mToolbarPositionArrowView = (ImageView) mToolbarView.findViewById(com.cyee.internal.R.id.cyee_toolbar_position_arrow);
    ...
    private void prepare(int screenX, int screenY, int cursorLineHeight, boolean selected) {
        ...
        if (aboveCursor) {
            ...
            mToolbarPositionArrowView.setPadding(paddingLeft, mOffsetToolbar - 2, 0, -2);
        }
        //gionee 20121210 guoyx modified for CR00734816 end
        ...
        if (context instanceof AppCompatActivity) {
            ...
            if (window != null) {
              ...
              return display.getHeight() - v.getBottom() + rect.top;   */
                return rect.top;
                // Gionee <gaoj> <2013-9-3> modify for CR00874531 end
        }
        }
        return 0;
    }
