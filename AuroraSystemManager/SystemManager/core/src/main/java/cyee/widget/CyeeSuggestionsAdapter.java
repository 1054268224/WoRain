 ...
 * @hide
 */
class CyeeSuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private final CyeeSearchView mSearchView;
    ...
    public CyeeSuggestionsAdapter(Context context, CyeeSearchView searchView,
            SearchableInfo searchable,
            WeakHashMap<String, Drawable.ConstantState> outsideDrawablesCache) {
        super(context,
                com.cyee.internal.R.layout.cyee_search_dropdown_item_icons_2line,
    ...
    private final static class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            mIconRefine = (ImageView) v.findViewById(com.cyee.internal.R.id.cyee_edit_query);
        }
    }
