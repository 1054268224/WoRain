 ...
 */
public abstract class CyeeBaseAdapterDecorator extends BaseAdapter {

    protected final BaseAdapter mDecoratedBaseAdapter;

    private AbsListView mListView;

    public CyeeBaseAdapterDecorator(BaseAdapter baseAdapter) {
    ...
    public void setListView(AbsListView listView) {
        ...
        if (mDecoratedBaseAdapter instanceof CyeeBaseAdapterDecorator) {
            ((CyeeBaseAdapterDecorator) mDecoratedBaseAdapter).setListView(listView);
        }
    }
    ...
    public void setAbsListView(AbsListView listView){
        ...
        if (mDecoratedBaseAdapter instanceof CyeeBaseAdapterDecorator) {
            ((CyeeBaseAdapterDecorator) mDecoratedBaseAdapter).setAbsListView(listView);
        }
    }
