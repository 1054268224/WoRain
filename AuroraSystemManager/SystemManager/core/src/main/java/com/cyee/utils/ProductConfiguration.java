...
public class ProductConfiguration {
    ...
    public static String getUAString() {
        return getUAStringWithContext(null);
    }
    
    public static String getUAStringWithContext(Context cxt){
        /*
        ...
        String strImei = getDeviceId(cxt);
    ...
    private static String getDeviceId(Context cxt) {
        String devId = null;

        if (null == cxt) {
            devId = TelephonyManager.getDefault().getDeviceId();
        } else {
            TelephonyManager tMgr = (TelephonyManager) cxt
