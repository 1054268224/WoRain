...
public class BatteryInfoUtils {
    ...
    public static long getNetworkActivityCount(Uid u, int type, int which) {
        long networkData = 0;
    ...
    public static long getTcpBytesReceived(Uid u, int which) {
    ...
    public static long getTcpBytesSent(Uid u, int which) {
        long bytesSent = 0;
