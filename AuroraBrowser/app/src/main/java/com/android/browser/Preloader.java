...
public class Preloader {
    ...
    private PreloaderSession getSession(String id) throws Exception {
        if (mSession == null) {
    ...
    public void handlePreloadRequest(String id, String url, Map<String, String> headers,
            String searchBoxQuery) throws Exception {
    ...
    public void cancelSearchBoxPreload(String id) throws Exception {
        PreloaderSession s = getSession(id);
        if (s != null) {
            s.touch(); // reset timer
            PreloadedTabControl tab = s.getTabControl();
    ...
    public void discardPreload(String id) throws Exception {
    ...
    private class PreloaderSession {
        ...
        public PreloaderSession(String id) throws Exception {
            mId = id;
