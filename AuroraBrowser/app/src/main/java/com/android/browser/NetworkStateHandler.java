...
public class NetworkStateHandler {
    ...
    public NetworkStateHandler(Activity activity, Controller controller) throws Exception {
        mActivity = activity;
        ...
        else { // internet not working
            Extensions.getNetworkStateHandlerPlugin(mActivity)
                    .promptUserToEnableData(mActivity);
        }
        /*
