...
public class BrowserWebViewFactory implements WebViewFactory {
    ...
    @Override
    public WebView createSubWebView(boolean privateBrowsing) throws Exception {
        return createWebView(privateBrowsing);
    }

    @Override
    public WebView createWebView(boolean privateBrowsing) throws Exception {
    ...
    protected void initWebViewSettings(WebView w) throws Exception {
