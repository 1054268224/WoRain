...
public class BookmarkWidgetConfigure extends ListActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccountAdapter = new ArrayAdapter<AddBookmarkPage.BookmarkAccount>(this,
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        AddBookmarkPage.BookmarkAccount account = mAccountAdapter.getItem(position);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        if (cursor == null || cursor.getCount() < 1) {
            ...
            while (cursor.moveToNext()) {
                mAccountAdapter.add(new AddBookmarkPage.BookmarkAccount(this, cursor));
            }
            setVisible(true);
        }
