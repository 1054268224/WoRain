...
public class Extensions {
     ...
     */
    public static IBrowserBookmarkExt getBookmarkPlugin(Context context) throws Exception {
     ...
     */
    public static IBrowserDownloadExt getDownloadPlugin(Context context) throws Exception {
     ...
     */
    public static IBrowserHistoryExt getHistoryPlugin(Context context) throws Exception {
     ...
     */
    public static IBrowserMiscExt getMiscPlugin(Context context) throws Exception {
        if (sMiscPlugin == null) {
            synchronized (Extensions.class) {
                if (sMiscPlugin == null) {
     ...
     */
    public static IBrowserRegionalPhoneExt getRegionalPhonePlugin(Context context) throws Exception {
     ...
     */
    public static IBrowserSettingExt getSettingPlugin(Context context) throws Exception {
     ...
     */
    public static IBrowserSiteNavigationExt getSiteNavigationPlugin(Context context) throws Exception {
     ...
     */
    public static IBrowserUrlExt getUrlPlugin(Context context) throws Exception {
        if (sUrlPlugin == null) {
            synchronized (Extensions.class) {
                if (sUrlPlugin == null) {
     ...
     */
    public static INetworkStateHandlerExt getNetworkStateHandlerPlugin(Context context) throws Exception {
